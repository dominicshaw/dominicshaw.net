...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: new google.maps.LatLng(51.4213934, -0.2008005),
    scrollwheel: false,
    draggable:false
  };
...
function loadGoogleMap(){
  ...
  script.src = 'https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyCgnbjiZUQOJXpj8PzSNmm616T-yF_hJVw&callback=initialize';
...
$(document).ready(function(){
  //slider
  var topSlider = $("#slider").sudoSlider({
   effect: "fade",
   pause: 3000,
   auto:true,
   continuous:true
  ...
  var photoSlider = $("#photoSlider").sudoSlider({
   effect: "fade",
   pause: 3000,
   auto:true,
   continuous:true
